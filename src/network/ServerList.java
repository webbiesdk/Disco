...
public class ServerList implements Receiver {
    MessageReceiver receiver; // The receiver that is called whenever this class doesn't know what to do with an received object.
    List<DeletedServerListener> deletedServerListeners = new ArrayList<>(); // The listener that is called whenever a server is removed from the cluster.
     ...
     *
     * @param receiver        The receiver that receives anything that this class doesn't know what to do with. That means, just about anything except some very specific classes that are also in this package.
     * @param reportAvailable Whether or not this node should report that it is available.
     */
    public ServerList(MessageReceiver receiver, boolean reportAvailable) {
    ...
    /**
     * Adds a deleted server listener.
     *
     * @param observer
     */
    public void addDeletedServerObserver(DeletedServerListener observer) {
        this.deletedServerListeners.add(observer);
    }
    ...
    public void viewAccepted(View new_view) {
        ...
        for (Address address : deleted) {
            ...
            for (DeletedServerListener deletedServerListener : deletedServerListeners) {
                deletedServerListener.serverDeleted(server);
            }
        }
     ...
     *
     * @param reportAvailable = true. busy = false;
     * @throws Exception
     */
